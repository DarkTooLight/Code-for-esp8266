...
void setup()
{
  ...
  //Declare what pins are connected to the digits
  int digit1 = D0; //Pin 7 on my 2 digit display
  int digit2 = D8; //Pin 8 on my 2 digit display
  int digit3 = 0;
  int digit4 = 0;

  //Declare what pins are connected to the segments
  int segA = D1; //Pin 10 on my 2 digit display
  int segB = D2; //Pin 9 on my 2 digit display
  int segC = D3; //Pin 1 on my 2 digit display
  int segD = D4; //Pin 4 on my 2 digit display
  int segE = D5; //Pin 3 on my 2 digit display
  int segF = D6; //Pin 6 on my 2 digit display
  int segG = D7; //Pin 5 on my 2 digit display
  int segDP= 1; //Pin 2 on my 2 digit display
